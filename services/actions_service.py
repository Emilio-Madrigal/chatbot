...
class ActionsService:
    ...
    def get_available_dates(self, user_id: str = None, phone: str = None, 
        ...
        try:
            ...
            if not ultimo_consultorio:
                print("[ACTIONS_SERVICE] No hay consultorio previo, buscando uno activo")
                # Buscar cualquier consultorio activo
                consultorios = self.get_consultorios_info(limit=1)
                if not consultorios:
                    print("[ACTIONS_SERVICE] No hay consultorios activos")
                    return []
                ...
                if consultorio_doc.exists:
                    ...
                    if dentista_id:
                        ...
                        print(f"[ACTIONS_SERVICE] No se encontró dentista activo en consultorio {consultorio_id}")
                        return []
                else:
                    print(f"[ACTIONS_SERVICE] Consultorio {consultorio_id} no existe")
                    return []
            ...
            print(f"[ACTIONS_SERVICE] Error obteniendo fechas disponibles: {e}")
            return []
    ...
    def get_available_times(self, user_id: str = None, phone: str = None,
        ...
        try:
            ...
            ultimo_consultorio = self.cita_repo.obtener_ultimo_consultorio_paciente(paciente.uid)
            if not ultimo_consultorio:
                print("[ACTIONS_SERVICE] No hay consultorio previo para horarios")
                # Buscar cualquier consultorio activo
                consultorios = self.get_consultorios_info(limit=1)
                if not consultorios:
                    print("[ACTIONS_SERVICE] No hay consultorios activos")
                ...
                if consultorio_doc.exists:
                    ...
                    if dentista_id:
                        ...
                        print(f"[ACTIONS_SERVICE] No se encontró dentista activo")
                        return []
                else:
                    print(f"[ACTIONS_SERVICE] Consultorio no existe")
                    return []
                ...
                try:
                    ...
                    try:
                        ...
                        try:
                            ...
                            print(f"[ACTIONS_SERVICE] Formato de fecha no reconocido: {fecha}")
            ...
            print(f"[ACTIONS_SERVICE] Error obteniendo horarios disponibles: {e}")
            return []
    ...
    def buscar_dentista_por_nombre(self, nombre_dentista: str, consultorio_id: str = None) -> Optional[Dict]:
        ...
        try:
            ...
            print(f"[ACTIONS_SERVICE] Error buscando dentista: {e}")
            import traceback
            traceback.print_exc()
            return None
    ...
    def create_appointment(self, user_id: str = None, phone: str = None,
        ...
        try:
            ...
            print(f"[ACTIONS_SERVICE] Error creando cita: {e}")
            import traceback
            traceback.print_exc()
            return {
                'success': False,
    ...
    def reschedule_appointment(self, user_id: str = None, phone: str = None,
        ...
        try:
            ...
            print(f"[ACTIONS_SERVICE] Error reagendando cita: {e}")
            import traceback
            traceback.print_exc()
            return {
                'success': False,
    ...
    def cancel_appointment(self, user_id: str = None, phone: str = None,
        ...
        try:
            ...
            print(f"[ACTIONS_SERVICE] Error cancelando cita: {e}")
            import traceback
            traceback.print_exc()
            return {
                'success': False,
    ...
    def get_dentists_info(self, limit: int = 10) -> List[Dict]:
        ...
        try:
            ...
            print(f"[ACTIONS_SERVICE] Error obteniendo dentistas: {e}")
            return []
    ...
    def get_consultorios_info(self, limit: int = 10) -> List[Dict]:
        ...
        try:
            ...
            print(f"[ACTIONS_SERVICE] Error obteniendo consultorios: {e}")
            return []
    ...
    def get_treatments_for_dentist(self, dentista_id: str, consultorio_id: str = None) -> List[Dict]:
        ...
        try:
            ...
            if not tratamientos:
                print(f"[ACTIONS_SERVICE] No se encontraron tratamientos para dentista {dentista_id}")
                return []
            
            return tratamientos
            
        except Exception as e:
            print(f"[ACTIONS_SERVICE] Error obteniendo tratamientos: {e}")
            import traceback
            traceback.print_exc()
            return []
    ...
    def quick_register_user(self, phone: str, name: str = None) -> Optional[Dict]:
        ...
        try:
            ...
            print(f"[ACTIONS_SERVICE] Error en registro rápido: {e}")
            return None
    ...
    def get_medical_history(self, user_id: str = None, phone: str = None) -> Dict[str, Any]:
        ...
        try:
            ...
            try:
                ...
                print("[ACTIONS_SERVICE] Módulo de encriptación no disponible, usando datos sin desencriptar")
                
            # 3. Retornar datos completos
            return historial_data
            
        except Exception as e:
            print(f"[ACTIONS_SERVICE] Error obteniendo historial médico: {e}")
            import traceback
            traceback.print_exc()
            return {}
    ...
    def get_dentist_reviews(self, dentista_name: str = None) -> List[Dict]:
        ...
        try:
            ...
            print(f"[ACTIONS_SERVICE] Error obteniendo reseñas: {e}")
    ...
    def search_dentists(self, query: str) -> List[Dict]:
        ...
        try:
            ...
            print(f"[ACTIONS_SERVICE] Error buscando dentistas: {e}")
            return []
