...
def normalize_phone_for_database(phone: str) -> str:
    ...
    3. Retorna el número normalizado
    
    Args:
        phone: Número de teléfono en cualquier formato (ej: "whatsapp:+1523330362181")
    ...
    # Si el número empieza con "+1" seguido de un código de país de 2 dígitos,
    # quitar el "1" extra
